<div class="pt-10 mt-10 border-t border-gray-100 comments-box">
    <h2 class="mb-5 text-2xl font-semibold text-gray-900">{{ __('blog.discussions') }}</h2>
    @auth
        ...
        <button style="background-color: #000000" wire:click="postComment"
    ...
    @else
        <a wire:navigate class="py-1 text-yellow-500 underline" href="{{ route('login') }}">{{ __('blog.login_to_comment') }}</a>
    @endauth
    <div class="px-3 py-2 mt-5 user-comments">
        ...
        @empty
            <div class="text-center text-gray-500">
                <span>{{ __('blog.no_comment_posted') }}</span>
            </div>
        @endforelse
    </div>
    <div class="my-2">
